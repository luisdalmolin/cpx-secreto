  ...
  "pt-BR": {
    translation: {
      ...
      groups: {
        ...
        editSubtitle: "Atualize o nome e a descrição deste grupo.",
        name: "Nome do grupo",
        ...
        dangerTitle: "Excluir grupo",
        dangerHint:
          "O grupo, suas edições e todo o histórico deixarão de ficar disponíveis.",
        delete: "Excluir este grupo",
        deleting: "Excluindo grupo…",
        deleteConfirmTitle: "Excluir este grupo?",
        deleteConfirmBody:
          "O grupo, suas edições e todo o histórico deixarão de ficar disponíveis. Esta ação não pode ser desfeita.",
        admin: "Administrador",
        member: "Participante",
        status: {
          invited: "Convidado",
      ...
      members: {
        ...
        editSubtitle: "Atualize os dados e a permissão desta pessoa.",
        ...
        roleHint:
          "Administradores podem gerenciar participantes, edições e sorteios.",
        create: "Adicionar",
      ...
      editions: {
        ...
        editSubtitle: "Atualize os dados antes de concluir o sorteio.",
        name: "Nome da edição",
        budget: "Orçamento sugerido em reais (opcional)",
        invalidBudget: "Use um valor válido para o orçamento.",
        ...
        editLocked: "Esta edição não pode mais ser alterada.",
        dangerTitle: "Excluir edição",
        dangerHint: "Somente edições em preparação podem ser excluídas.",
        delete: "Excluir esta edição",
        deleting: "Excluindo edição…",
        deleteConfirmTitle: "Excluir esta edição?",
        deleteConfirmBody:
          "A edição e sua lista de participantes serão excluídas. Esta ação não pode ser desfeita.",
        status: {
          draft: "Em preparação",
          open: "Aberta",
          drawn: "Sorteada",
